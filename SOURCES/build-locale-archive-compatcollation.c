...
const char *alias_file = PREFIX "/share/" LOCALE_FOLDER "/locale.alias";
const char *locar_file = PREFIX "/lib/" LOCALE_FOLDER "/locale-archive";
const char *tmpl_file = PREFIX "/lib/" LOCALE_FOLDER "/locale-archive.tmpl";
const char *loc_path = PREFIX "/lib/" LOCALE_FOLDER "/";
...
{
  printf ("\
Usage: build-locale-archive-compatcollation [OPTION]... [TEMPLATE-FILE] [ARCHIVE-FILE]\n\
