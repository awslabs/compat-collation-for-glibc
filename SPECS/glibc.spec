...
%defattr(-,root,root)
%{compatprefix}/lib64/gconv-compatcollation%{compatcollationversion_nodots}
%{compatprefix}/lib/locale-compatcollation%{compatcollationversion_nodots}
%{compatprefix}/share/locale-compatcollation%{compatcollationversion_nodots}
%{compatprefix}/lib64/libcompatcollation.%{glibcversion}-%{glibcrelease}.so
%{compatprefix}/sbin/build-locale-archive-compatcollation%{compatcollationversion_nodots}

%posttrans compatcollation%{compatcollationversion_nodots}
%{compatprefix}/sbin/build-locale-archive-compatcollation%{compatcollationversion_nodots}

%postun compatcollation%{compatcollationversion_nodots}
rm -f %{compatprefix}/lib/locale-compatcollation%{compatcollationversion_nodots}/locale-archive
...
install -m 700 build-locale-archive $RPM_BUILD_ROOT/sbin/build-locale-archive
popd
...
%changelog
* Tue Apr 12 2022 Benjamin Herrenschmidt <benh@kernel.crashing.org> - 2.26-59
- Revert removal of strcoll() cache as it causes a large performance regression
  with some locales

* Mon Mar 21 2022 Mansi Jaitly <mjaitly@amazon.com> - 2.26-58
- CVE-2022-23218: Stack-based buffer overflow in svcunix_create via long pathnames (#2042013)
- CVE-2022-23219: Stack-based buffer overflow in sunrpc clnt_create via a long pathname (#2042017)

* Tue Dec 28 2021 Nikhil Dikshit <nikhildi@amazon.com> - 2.26-57
- librt: fix NULL pointer dereference (#1966472)
- CVE-2021-33574: Deep copy pthread attribute in mq_notify (#1966472)

* Mon Sep 27 2021 Nikhil Dikshit <nikhildi@amazon.com> - 2.26-56
- Add IPPROTO_ETHERNET and IPPROTO_MPTCP constants from Linux 5.6 to 
  glibc's netinet/in.h.

* Sat Sep 25 2021 Benjamin Herrenschmidt <benh@amazon.com> - 2.26-55
- nss_files: Fix regression resolving ipv6 addresses from /etc/hosts

* Fri Sep 17 2021 Benjamin Herrenschmidt <benh@amazon.com> - 2.26-54
- nss_files: Fix crash when calling nss_files functions from a statically
  linked program.

* Mon Aug 30 2021 Benjamin Herrenschmidt <benh@amazon.com> - 2.26-53
- elf: Add NT_ARM_SVE
- aarch64: make HWCAP updates less error prone
- aarch64: Add AArch64 HWCAP_DCPOP from Linux 4.14
- aarch64: Update bits/hwcap.h for Linux 4.15
- elf: Add elf.h NT_* macros from Linux 4.15 (bug 14890).
...
* Wed Aug 25 2021 Benjamin Herrenschmidt <benh@amazon.com> - 2.26-52
...
* Fri Aug 20 2021 Nikhil Dikshit <nikhildi@amazon.com> - 2.26-51
- CVE-2021-35942: handle overflow in positional parameter number

* Wed Aug 18 2021 Nikhil Dikshit <nikhildi@amazon.com> - 2.26-50
- nss_files: Fix nss_files problem due to new symbols dependencies

* Wed Jul 21 2021 Nikhil Dikshit <nikhildi@amazon.com> - 2.26-49
- fseeko64: Fix i686 build
- nss_files: Fix re-reading of long lines [BZ #18991]
- libio: Implement internal function __libc_readline_unlocked

* Tue Jun 22 2021 Nikhil Dikshit <nikhildi@amazon.com> - 2.26-48
- Added New file: sysdeps/unix/sysv/linux/aarch64/sysconf.c
- Guess L1 cache linesize for aarch64

* Mon Jun 14 2021 Nikhil Dikshit <nikhildi@amazon.com> - 2.26-47
- CVE-2019-9169: fix read overrun [BZ #24114]
- CVE-2020-27618: Accept redundant shift sequences in IBM1364 [BZ #26224]

* Tue May 25 2021 Benjamin Herrenschmidt <benh@amazon.com> - 2.26-46
- Remove obsolete RES_INSECURE1 and RES_INSECURE2 resolver
  features (always perform the validation)
- Fix handling of duplicate transaction IDs in parallel IPv4
  and IPv6 resolver requests

* Tue Apr 27 2021 Nikhil Dikshit <nikhildi@amazon.com> - 2.26-45
- Added patch to improve performance on memcpy on graviton2

* Wed Apr 14 2021 Paul Ezvan <paulezva@amazon.fr> - 2.26-44
- Add epoll_wait fix

* Fri Mar 05 2021 Jian Zheng <zhejan@amazon.com> - 2.26-43
- ja_JP: Add new Japanese Era name (#1555189)

* Mon Feb 22 2021 Nikhil Dikshit <nikhildi@amazon.com> - 2.26-42
- CVE-2021-3326: Fix assertion failure in ISO-2022-JP-3 module (bug #27256)

* Mon Feb 15 2021 Nikhil Dikshit <nikhildi@amazon.com> - 2.26-41
- CVE-2020-6096: Fix multiarch memcpy for negative length (bz #25620)
- CVE-2016-10228: Rewrite iconv option parsing (bz #19519)
- CVE-2020-29562: Fix incorrect UCS4 inner loop bounds (bz#26923)

* Tue Feb 02 2021 Nikhil Dikshit <nikhildi@amazon.com> - 2.26-40
- CVE-2019-25013: Fix buffer overrun in EUC-KR conversion module (bz #24973)

* Fri Nov 20 2020 Benjamin Herrenschmidt <benh@amazon.com> - 2.26-39
- resolv: Fix duplicate DNS transaction IDs on Graviton 2 instance types
  by using a higher resolution clock.
...
* Thu Oct 29 2020 Frederick Lefebvre <fredlef@amazon.com> - 2.26-37
- Fix year 2039 bug for localtime with 64-bit time_t
